...
import { addStock, type AddStockItemRef } from '@/cupnudle/lib/stocks';
 ...
 *
 * どこを変更すればよいか:
 * - 登録後遷移先を変える場合は `router.push('/cupnudle')` の引数を変更する。
...
export default function StocksNewPage() {
  ...
  const MASTER_CREATE_PATH = '/cupnudle/items';
